<template>
  <div class="ui-home">
    <h2 class="ui-title">Editor.js 插件</h2>
    <h3 class="plugin-title">Block 块插件</h3>
    <ul class="ui-project">
      <li class="item" v-for="v in blockData" :key="v.name">
...
<script setup>
import { blockData } from '../model/siteData.js'

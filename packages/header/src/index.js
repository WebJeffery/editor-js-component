...
export default class Header {
  ...
  get defaultLevel() {
    ...
    if (this._settings.defaultLevel) {
      const userSpecified = this.levels.find((levelItem) => levelItem.number === this._settings.defaultLevel)
  ...
  onPaste(event) {
    ...
    if (this._settings.levels) {
      ...
      level = this._settings.levels.reduce((prevLevel, currLevel) => (Math.abs(currLevel - level) < Math.abs(prevLevel - level) ? currLevel : prevLevel))
    }
